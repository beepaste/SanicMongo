...
from SanicMongo.fields import ReferenceField, ComplexBaseField
from SanicMongo.metaprogramming import (AsyncDocumentMetaclass, Async, Sync,
                                        get_future)
from SanicMongo.queryset import QuerySet
...
class Document(DocumentBase, metaclass=AsyncDocumentMetaclass):
    ...
    :class:`~SanicMongo.Document` subclass.

    By default, the MongoDB collection used to store documents created using a
    :class:`~SanicMongo.Document` subclass will be the name of the subclass
    converted to lowercase. A different collection may be specified by
    providing :attr:`collection` to the :attr:`meta` dictionary in the class
    definition.

    A :class:`~SanicMongo.Document` subclass may be itself subclassed, to
    ...
    A :class:`~SanicMongo.Document` may use a **Capped Collection** by
    ...
    True then indexes will be created by SanicMongo.
    ...
    def drop_collection(cls):
        ...
        :class:`SanicMongo.Document` type from the database.
        """
